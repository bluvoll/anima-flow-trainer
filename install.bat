...
rem ---------------------------------------------------------------- launcher
echo ==^> writing start-gui.bat
(
    echo @echo off
    echo rem Start the Anima trainer GUI. Generated by install.bat -- safe to delete and regenerate.
    echo cd /d "%%~dp0"
    echo "%%~dp0venv\Scripts\python.exe" -m anima.gui %%*
...
:help
echo install.bat              install into .\venv and write .\start-gui.bat
