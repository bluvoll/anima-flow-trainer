...
write_launcher start-gui.sh       anima.gui                 "Start the Anima trainer GUI."
write_launcher start-converter.sh anima.tools.convert_model "Convert single-file Anima checkpoints into a diffusers repo."
...
echo "    ${DIM}convert a single-file checkpoint:  ./start-converter.sh${OFF}"
